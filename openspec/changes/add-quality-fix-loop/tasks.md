...
- [ ] 1.1 Add quality report, quality issue, fix plan, and fix loop record models.
- [ ] 1.2 Extend the JSON metadata repository with quality report and fix loop persistence.
...
- [ ] 2.1 Implement DOCX quality inspection for profile margins, body style, headings, table borders, captions, raw LaTeX residue, and page-number unsupported status.
...
- [ ] 4.1 Add quality report creation and retrieval APIs for formatted output files.
